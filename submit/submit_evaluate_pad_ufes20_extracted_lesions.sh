#!/bin/bash
#SBATCH --job-name=evaluate_pad_ufes20_extracted_lesions
...
if [[ -f evaluate_pad_ufes20_extracted_lesions.py ]]; then
    SCRIPT_PATH="evaluate_pad_ufes20_extracted_lesions.py"
else
    SCRIPT_PATH="src/evaluate_pad_ufes20_extracted_lesions.py"
fi
