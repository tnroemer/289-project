#!/bin/bash
#SBATCH --job-name=train_ham10000_full_image_resnet
...
if [[ -f train_ham10000_full_image_resnet.py ]]; then
    SCRIPT_PATH="train_ham10000_full_image_resnet.py"
else
    SCRIPT_PATH="src/train_ham10000_full_image_resnet.py"
fi
